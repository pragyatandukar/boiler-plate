...
class _TimerEvt(object):
    ...
    def dispatch(self):
        ...
        LOGGER.debug('_TimerEvt.dispatch: invoking callback=%r',
                     self._callback)
        self._callback()
...
class BlockingConnection(object):
    ...
    def _flush_output(self, *waiters):
        ...
        is_done = (lambda: self._closed_result.ready or (
            (not self._impl._transport or self._impl._get_write_buffer_size()
             == 0) and (not waiters or any(ready() for ready in waiters))))
...
class BlockingChannel(object):
    ...
    def basic_cancel(self, consumer_tag):
        ...
        try:
            ...
            assert (consumer_info.cancelled_by_broker
                    or consumer_tag in self._impl._consumers), consumer_tag
            ...
            with self._message_confirmation_result:
                ...
                if isinstance(conf_method, pika.spec.Basic.Nack):
                    ...
                    LOGGER.warning(
                        ...
                        conf_method, self.channel_number, exchange,
                        routing_key, mandatory)
