...
class Definition(Binding):
    ...
    def redefines(self, other):
        return (super().redefines(other)
                or (isinstance(other, Assignment) and self.name == other.name))
...
class VariableKey:
    ...
    def __eq__(self, compare):
        return (compare.__class__ == self.__class__
...
class FunctionScope(Scope):
    ...
    def unused_assignments(self):
        ...
        for name, binding in self.items():
            if (not binding.used and name != '_' and  # see issue #202
...
def is_typing_overload(value, scope_stack):
    return (isinstance(value.source, (ast.FunctionDef, ast.AsyncFunctionDef))
            and any(
...
class Checker:
    ...
    def getCommonAncestor(self, lnode, rnode, stop):
        if (stop in (lnode, rnode)
                or not (hasattr(lnode, '_pyflakes_parent')
    ...
    def addBinding(self, node, value):
        ...
        if (existing and not isinstance(existing, Builtin)
            ...
            if isinstance(existing, Importation) and isinstance(
                ...
                if ((not existing.used and value.redefines(existing)) and
    ...
    def handleNodeStore(self, node):
        ...
        if isinstance(parent_stmt,
            ...
            binding = Binding(name, node)
              ...
              and isinstance(node._pyflakes_parent,
    ...
    def handleNode(self, node, parent):
        ...
        if (self.futuresAllowed and self.nodeDepth == 0
    ...
    def _handle_percent_format(self, node):
        ...
        if (isinstance(node.right, (ast.List, ast.Tuple)) and
                ...
                not any(
                    isinstance(elt, ast.Starred) for elt in node.right.elts)):
    ...
    def COMPARE(self, node):
        ...
        for op, right in zip(node.ops, node.comparators):
            if (isinstance(op, (ast.Is, ast.IsNot))
                    and (_is_const_non_singleton(left)
