...
from psycopg2._psycopg import (  # noqa
    REPLICATION_PHYSICAL, REPLICATION_LOGICAL, ReplicationConnection as
    _replicationConnection, ReplicationCursor as _replicationCursor,
    ReplicationMessage)
...
class LoggingConnection(_connection):
    ...
    def initialize(self, logobj):
        ...
        """
        self._logobj = logobj
        if _logging and isinstance(logobj,
...
def register_inet(oid=None, conn_or_curs=None):
    ...
    """
    import warnings
    warnings.warn("the inet adapter is deprecated, it's not very useful",
                  DeprecationWarning)
