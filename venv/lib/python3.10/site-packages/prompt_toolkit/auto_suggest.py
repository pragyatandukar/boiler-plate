...
class AutoSuggest(metaclass=ABCMeta):
    ...
    def get_suggestion(self, buffer: Buffer,
                       document: Document) -> Suggestion | None:
        """
    ...
    async def get_suggestion_async(self, buff: Buffer,
                                   document: Document) -> Suggestion | None:
        """
...
class ThreadedAutoSuggest(AutoSuggest):
    ...
    def get_suggestion(self, buff: Buffer,
                       document: Document) -> Suggestion | None:
...
class DynamicAutoSuggest(AutoSuggest):
    ...
    def __init__(self, get_auto_suggest: Callable[[],
