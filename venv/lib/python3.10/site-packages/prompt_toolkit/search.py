...
class SearchState:
    ...
    def __invert__(self) -> SearchState:
        ...
        return SearchState(text=self.text,
                           direction=direction,
...
def stop_search(buffer_control: BufferControl | None = None) -> None:
    ...
    if buffer_control is None:
        ...
        search_buffer_control = _get_reverse_search_links(
            layout)[buffer_control]
...
def do_incremental_search(direction: SearchDirection, count: int = 1) -> None:
    ...
    if not direction_changed:
        prev_control.buffer.apply_search(search_state,
...
def accept_search() -> None:
    ...
    # Apply search.
    target_buffer_control.buffer.apply_search(search_state,
...
def _get_reverse_search_links(
    ...
    return {
        ...
        for search_buffer_control, buffer_control in
        layout.search_links.items()
    }
