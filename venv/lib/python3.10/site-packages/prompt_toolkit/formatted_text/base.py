...
OneStyleAndTextTuple = Union[Tuple[str, str],
                             Tuple[str, str, Callable[[MouseEvent],
...
def to_formatted_text(value: AnyFormattedText,
                      style: str = "",
...
def merge_formatted_text(
        items: Iterable[AnyFormattedText]) -> AnyFormattedText:
    """
