...
class KeyBindings(KeyBindingsBase):
    ...
    def __init__(self) -> None:
        ...
        self._get_bindings_for_keys_cache: SimpleCache[
            KeysTuple, list[Binding]] = SimpleCache(maxsize=10000)
        self._get_bindings_starting_with_keys_cache: SimpleCache[
            KeysTuple, list[Binding]] = SimpleCache(maxsize=1000)
...
def merge_key_bindings(
        bindings: Sequence[KeyBindingsBase]) -> _MergedKeyBindings:
    """
...
class DynamicKeyBindings(_Proxy):
    ...
    def __init__(
            self, get_key_bindings: Callable[[],
