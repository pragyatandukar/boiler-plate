...
class Win32Input(_Win32InputBase):
    ...
    def attach(
            self,
            input_ready_callback: Callable[[], None]) -> ContextManager[None]:
        """
...
class ConsoleInputReader:
    ...
    mappings = {
        ...
        b"\x0b":
        Keys.ControlK,  # Control-K (delete until end of line; vertical tab)
        ...
        b"\x1f":
        Keys.ControlUnderscore,  # Control-underscore (Also for Ctrl-hyphen.)
    ...
    def _get_keys(self, read: DWORD,
                  input_records: Array[INPUT_RECORD]) -> Iterator[KeyPress]:
        """
...
@contextmanager
def attach_win32_input(input: _Win32InputBase,
                       callback: Callable[[], None]) -> Iterator[None]:
    """
