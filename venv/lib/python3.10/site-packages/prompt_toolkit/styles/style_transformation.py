...
class SetDefaultColorStyleTransformation(StyleTransformation):
    ...
    def __init__(self, fg: str | Callable[[], str],
                 bg: str | Callable[[], str]) -> None:
        self.fg = fg
        self.bg = bg
...
class AdjustBrightnessStyleTransformation(StyleTransformation):
    ...
    def __init__(self,
                 ...
                 max_brightness: AnyFloat = 1.0) -> None:
...
class DynamicStyleTransformation(StyleTransformation):
    ...
    def __init__(
        self, get_style_transformation: Callable[[],
                                                 StyleTransformation | None]
    ) -> None:
        self.get_style_transformation = get_style_transformation

    def transform_attrs(self, attrs: Attrs) -> Attrs:
        style_transformation = (self.get_style_transformation()
                                or DummyStyleTransformation())
...
class _MergedStyleTransformation(StyleTransformation):
    ...
    def __init__(self,
                 style_transformations: Sequence[StyleTransformation]) -> None:
