...
class FormattedTextControl(UIControl):
    ...
    def create_content(self, width: int, height: int | None) -> UIContent:
        ...
        def get_cursor_position(
            fragment: str = "[SetCursorPosition]", ) -> Point | None:
...
class BufferControl(UIControl):
    ...
    def __init__(
        ...
        search_buffer_control: (None | SearchBufferControl
        ...
        self._last_get_processed_line: Callable[[int],
                                                _ProcessedLine] | None = None
    ...
    def preferred_height(
        ...
        # given width.
        height = 0
        content = self.create_content(width,
                                      height=1)  # Pass a dummy '1' as height.
    ...
    def _create_get_processed_line_func(
            self, document: Document, width: int,
            height: int) -> Callable[[int], _ProcessedLine]:
        """
        ...
        def transform(lineno: int,
                      fragments: StyleAndTextTuples) -> _ProcessedLine:
        ...
        if get_app().layout.current_control == self:
            if self._last_get_processed_line:
                ...
                if mouse_event.event_type == MouseEventType.MOUSE_DOWN:
                    ...
                    double_click = (self._last_click_timestamp
                                    and time.time() -
                                    self._last_click_timestamp < 0.3)
