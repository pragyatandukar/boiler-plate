...
class ScrollablePane(Container):
    ...
    def preferred_height(self, width: int,
        ...
        dimension = self.content.preferred_height(width,
    ...
    def _copy_over_write_positions(self, screen: Screen, temp_screen: Screen,
    ...
    def _make_window_visible(
        ...
        if self.keep_cursor_visible():
            ...
            if cursor_position is not None:
                ...
                cpos_min_scroll = (cursor_position.y - visible_height + 1 +
                                   offsets.bottom)
    ...
    def _draw_scrollbar(self, write_position: WritePosition,
                        content_height: int, screen: Screen) -> None:
        """
        ...
        try:
            ...
            # Up arrow.
            if display_arrows:
                data_buffer[ypos][xpos] = Char(self.up_arrow_symbol,
            ...
            # Down arrow
            if display_arrows:
                data_buffer[ypos][xpos] = Char(self.down_arrow_symbol,
                                               "class:scrollbar.arrow")
