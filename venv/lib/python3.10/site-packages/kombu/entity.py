...
class Exchange(MaybeChannelBound):
    ...
    def Message(self, body, delivery_mode=None, properties=None, **kwargs):
        ...
        if (isinstance(body, str)
                and properties.get('content_encoding', None)) is None:
...
class binding(Object):
    ...
    attrs = (('exchange', None), ('routing_key', None), ('arguments', None),
...
class Queue(MaybeChannelBound):
    ...
    attrs = (('name', None), ('exchange', None), ('routing_key', None),
             ('queue_arguments', None), ('binding_arguments',
                                         None), ('consumer_arguments', None),
             ('durable', bool), ('exclusive', bool), ('auto_delete', bool),
             ('no_ack', None), ('alias', None), ('bindings', list),
             ('no_declare', bool), ('expires', float), ('message_ttl', float),
             ('max_length', int), ('max_length_bytes', int), ('max_priority',
                                                              int))
    ...
    def queue_bind(self, nowait=False, channel=None):
        ...
        return self.bind_to(self.exchange,
                            self.routing_key,
    ...
    def queue_unbind(self, arguments=None, nowait=False, channel=None):
        return self.unbind_from(self.exchange, self.routing_key, arguments,
                                nowait, channel)
    ...
    def __eq__(self, other):
        if isinstance(other, Queue):
            return (self.name == other.name and self.exchange == other.exchange
