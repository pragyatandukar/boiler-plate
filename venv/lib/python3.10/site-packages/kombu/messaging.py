...
class Producer:
    ...
    def publish(self,
        ...
        body, content_type, content_encoding = self._prepare(
            body, serializer, content_type, content_encoding, compression,
            headers)
        ...
        return _publish(body, priority, content_type, content_encoding,
...
class Consumer:
    ...
    def qos(self, prefetch_size=0, prefetch_count=0, apply_global=False):
        ...
        """
        return self.channel.basic_qos(prefetch_size, prefetch_count,
                                      apply_global)
