...
class BrokerState:
    ...
    def queue_bindings(self, queue):
        return (queue_binding_t(key.exchange, key.routing_key,
                                self.bindings[key])
...
class Channel(AbstractChannel, base.StdChannel):
    ...
    def list_bindings(self):
        return ((queue, exchange, rkey) for exchange in self.state.exchanges
    ...
    def basic_publish(self, message, exchange, routing_key, **kwargs):
        ...
        if exchange:
            return self.typeof(exchange).deliver(message, exchange,
                                                 routing_key, **kwargs)
    ...
    def _reset_cycle(self):
        self._cycle = FairCycle(self._get_and_deliver, self._active_queues,
                                Empty)
