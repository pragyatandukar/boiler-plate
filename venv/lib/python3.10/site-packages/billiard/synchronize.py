...
class BoundedSemaphore(Semaphore):
    ...
    def __repr__(self):
        try:
            ...
            value = 'unknown'
        return '<%s(value=%s, maxvalue=%s)>' % (self.__class__.__name__, value,
...
class Condition:
    ...
    def __setstate__(self, state):
        (self._lock, self._sleeping_count, self._woken_count,
         self._wait_semaphore) = state
        self._make_methods()
...
if hasattr(threading, 'Barrier'):
    ...
    class Barrier(threading.Barrier):
        ...
        def __setstate__(self, state):
            (self._parties, self._action, self._timeout, self._cond,
             self._wrapper) = state
            self._array = self._wrapper.create_memoryview().cast('i')

        def __getstate__(self):
            return (self._parties, self._action, self._timeout, self._cond,
                    self._wrapper)
