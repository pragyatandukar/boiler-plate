    ...
    def get_keys(self, subpath, method, view):
        ...
        if is_custom_action(action):
            ...
            mapped_methods = {
                ...
                method
                for method in view.action_map if method != 'head'
            }
...
def field_to_schema(field):
    ...
    if isinstance(field, (serializers.ListSerializer, serializers.ListField)):
        ...
        return coreschema.Array(items=related_field_schema,
                                title=title,
                                description=description)
...
class AutoSchema(ViewInspector):
    ...
    def get_link(self, path, method, base_url):
        ...
        * base_url: The project "mount point" as given to SchemaGenerator
        ...
        return coreapi.Link(url=parse.urljoin(base_url, path),
                            action=method.lower(),
                            encoding=encoding,
                            fields=fields,
                            description=description)
...
class ManualSchema(ViewInspector):
    ...
    def __init__(self, fields, description='', encoding=None):
        ...
        * `description`: String description for view. Optional.
        ...
        assert all(
            isinstance(f, coreapi.Field) for f in
            fields), "`fields` must be a list of coreapi.Field instances"
        self._fields = fields
