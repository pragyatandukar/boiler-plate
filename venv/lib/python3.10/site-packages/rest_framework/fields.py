...
def is_simple_callable(obj):
    ...
    return all(
        ...
        or param.default != param.empty for param in params)
    ...
    for attr in attrs:
        ...
        if is_simple_callable(instance):
            try:
                ...
                raise ValueError(
                    'Exception raised in callable attribute "{}"; original exception was: {}'
                    .format(attr, exc))
    ...
    try:
        ...
        return [
            ErrorDetail((error.message %
                         error.params) if error.params else error.message,
    ...
    def to_internal_value(self, data):
        with contextlib.suppress(TypeError):
            if self._lower_if_str(data) in self.TRUE_VALUES:
                ...
                return False
            elif self._lower_if_str(
                    data) in self.NULL_VALUES and self.allow_null:
                return None
...
class CharField(Field):
    ...
    def __init__(self, **kwargs):
        ...
        if self.min_length is not None:
            message = lazy_format(self.error_messages['min_length'],
    ...
    def to_internal_value(self, data):
        ...
        if isinstance(data, bool) or not isinstance(data, (
                str,
                int,
                float,
        )):
...
class SlugField(CharField):
    ...
    def __init__(self, allow_unicode=False, **kwargs):
        ...
        if self.allow_unicode:
            ...
            validator = RegexValidator(re.compile(r'^[-a-zA-Z0-9_]+$'),
                                       message=self.error_messages['invalid'])
        self.validators.append(validator)
...
class IntegerField(Field):
    ...
    re_decimal = re.compile(
        r'\.0*\s*$')  # allow e.g. '1.0' as an int, but not '1.2'
    ...
    def __init__(self, **kwargs):
        ...
        if self.max_value is not None:
            message = lazy_format(self.error_messages['max_value'],
                                  max_value=self.max_value)
            self.validators.append(
                MaxValueValidator(self.max_value, message=message))
        if self.min_value is not None:
            message = lazy_format(self.error_messages['min_value'],
...
class FloatField(Field):
    default_error_messages = {
        ...
        _('String value too large.'),
        'overflow':
        _('Integer value too large to convert to float')
    }
    MAX_STRING_LENGTH = 1000  # Guard against malicious string inputs.
...
class DecimalField(Field):
    ...
    def to_representation(self, value):
        coerce_to_string = getattr(self, 'coerce_to_string',
    ...
    def quantize(self, value):
        ...
        return value.quantize(decimal.Decimal('.1')**self.decimal_places,
...
class DurationField(Field):
    default_error_messages = {
        ...
        _('Ensure this value is greater than or equal to {min_value}.'),
        'overflow':
        _('The number of days must be between {min_days} and {max_days}.'),
    }
...
class ChoiceField(Field):
    ...
    def __init__(self, choices, **kwargs):
        ...
        self.html_cutoff_text = kwargs.pop('html_cutoff_text',
    ...
    def _set_choices(self, choices):
        ...
        self.choice_strings_to_values = {
            str(key.value) if isinstance(key, Enum) and str(key) != str(key.value) else str(key):
            key
...
class FilePathField(ChoiceField):
    ...
    def __init__(self,
        ...
        field = DjangoFilePathField(path,
                                    match=match,
                                    recursive=recursive,
...
class ImageField(FileField):
    ...
    def __init__(self, **kwargs):
        self._DjangoImageField = kwargs.pop('_DjangoImageField',
                                            DjangoImageField)
        super().__init__(**kwargs)
    ...
    def get_value(self, dictionary):
        ...
        if html.is_html_input(dictionary):
            ...
            if len(val) > 0:
                ...
                return val
            return html.parse_html_list(dictionary,
...
class DictField(Field):
    ...
    default_error_messages = {
        ...
        'empty':
        _('This dictionary may not be empty.'),
    }
    ...
    def to_representation(self, value):
        return {
            str(key):
            self.child.to_representation(val) if val is not None else None
