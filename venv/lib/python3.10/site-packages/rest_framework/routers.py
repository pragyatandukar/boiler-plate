...
class BaseRouter:
    ...
    def is_already_registered(self, new_basename):
        ...
        """
        return any(basename == new_basename
                   for _prefix, _viewset, basename in self.registry)
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        if lookup_value is None:
            ...
            lookup_value = getattr(viewset, 'lookup_value_regex',
                                   self._default_value_pattern)
        return self._base_pattern.format(lookup_prefix=lookup_prefix,
