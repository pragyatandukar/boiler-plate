...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_content(self, renderer, data, accepted_media_type,
        ...
        return content.decode('utf-8') if isinstance(content,
                                                     bytes) else content
    ...
    def get_raw_data_form(self, data, view, method, request):
        ...
        with override_method(view, request, method) as request:
            ...
            if hasattr(view, 'get_serializer') and renderer_class:
                ...
                is_list_serializer = isinstance(serializer,
                                                serializers.ListSerializer)
...
class AdminRenderer(BrowsableAPIRenderer):
    ...
    def get_result_url(self, result, view):
        ...
        lookup_url_kwarg = getattr(view, 'lookup_url_kwarg',
...
class OpenAPIRenderer(BaseRenderer):
    ...
    def render(self, data, media_type=None, renderer_context=None):
        ...
        Dumper.add_representer(datetime.timedelta,
                               encoders.CustomScalar.represent_timedelta)
        return yaml.dump(data,
                         default_flow_style=False,
                         sort_keys=False,
                         Dumper=Dumper).encode('utf-8')
