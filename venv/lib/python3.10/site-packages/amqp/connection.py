...
class Connection(AbstractChannel):
    ...
    _ALLOWED_METHODS_WHEN_CLOSING = (spec.Connection.Close,
    ...
    def _on_start(self,
        ...
        for authentication in self.authentication:
            ...
            raise ConnectionError("Couldn't find appropriate auth mechanism "
        ...
        self.send_method(
            ...
            argsig,
            (client_properties, authentication.mechanism, login_response,
             self.locale),
        )
    ...
    def _on_close(self, reply_code, reply_text, class_id, method_id):
        ...
        """
        self._x_close_ok()
        raise error_for_code(reply_code, reply_text, (class_id, method_id),
                             ConnectionError)
