...
class DecisionEngine:
    ...
    def make_decision(self, code: str) -> Decision:
        ...
        elif (selected is Selected.Explicitly
              and ignored is not Ignored.Explicitly):
            return Decision.Selected
        elif (selected is not Selected.Explicitly
              and ignored is Ignored.Explicitly):
            return Decision.Ignored
        elif selected is Ignored.Implicitly and ignored is Selected.Implicitly:
            return Decision.Ignored
        elif (selected is Selected.Explicitly and ignored
              is Ignored.Explicitly) or (selected is Selected.Implicitly
...
class StyleGuideManager:
    ...
    def populate_style_guides_with(
            self,
            options: argparse.Namespace) -> Generator[StyleGuide, None, None]:
    ...
    def processing_file(self,
                        filename: str) -> Generator[StyleGuide, None, None]:
    ...
    def handle_error(
        ...
        """
        guide = self.style_guide_for(filename)
        return guide.handle_error(code, filename, line_number, column_number,
                                  text, physical_line)
...
class StyleGuide:
    ...
    def handle_error(
        ...
        error_is_selected = (self.should_report_error(error.code)
