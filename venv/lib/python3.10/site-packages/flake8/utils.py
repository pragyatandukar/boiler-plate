...
def parse_comma_separated_list(
        value: str,
        regexp: Pattern[str] = COMMA_SEPARATED_LIST_RE) -> list[str]:
...
def parse_files_to_codes_mapping(  # noqa: C901
        value_: Sequence[str] | str, ) -> list[tuple[str, list[str]]]:
...
def normalize_paths(paths: Sequence[str],
                    parent: str = os.curdir) -> list[str]:
