...
class Option:
    ...
    def __init__(
        ...
        """
        if (long_option_name is _ARG.NO and short_option_name is not _ARG.NO
        ...
        self.option_args = [
            x for x in (short_option_name, long_option_name)
            if x is not _ARG.NO
        ]
        self.action = action
    ...
    def filtered_option_kwargs(self) -> dict[str, Any]:
        ...
        return {
            k: v
            for k, v in self.option_kwargs.items() if v is not _ARG.NO
        }
    ...
    def __init__(
        ...
        *,
        ...
        self.parser.add_argument(
            "--version",
            action="version",
            version=(f"{version} ({plugin_versions}) "
