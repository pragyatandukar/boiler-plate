...
class AsyncBackendMixin:
    ...
    def _wait_for_pending(self,
                          ...
                          on_message=None,
                          **kwargs):
        return self.result_consumer._wait_for_pending(result,
                                                      timeout=timeout,
...
class BaseResultConsumer:
    ...
    def drain_events_until(self, p, timeout=None, on_interval=None):
        return self.drainer.drain_events_until(p,
                                               timeout=timeout,
                                               on_interval=on_interval)
    ...
    def _wait_for_pending(self,
        ...
        try:
            for _ in self.drain_events_until(result.on_ready,
                                             timeout=timeout,
                                             on_interval=on_interval):
                yield
                sleep(0)
