...
class AzureBlockBlobBackend(KeyValueStoreBackend):
    ...
    def __init__(self, url=None, container_name=None, *args, **kwargs):
        ...
        self._container_name = (container_name
                                or conf["azureblockblob_container_name"])
    ...
    def get(self, key):
        ...
        LOGGER.debug("Getting Azure Block Blob %s/%s", self._container_name,
                     key)
    ...
    def as_uri(self, include_password=False):
        ...
        redacted_connection_string_parts = [
            f'{account_key_prefix}**'
            if part.startswith(account_key_prefix) else part
