...
def heartbeat_expires(timestamp,
                      freq=60,
...
class Worker:
    ...
    def _create_event_handler(self):
        ...
        def event(type_,
            ...
            if type_ == 'offline':
                ...
                if drift > max_drift:
                    _warn_drift(self.hostname, drift, local_received,
                                timestamp)
    ...
    def heartbeat_expires(self):
        return heartbeat_expires(self.heartbeats[-1], self.freq,
                                 self.expire_window)
...
class Task:
    ...
    def parent(self):
        ...
        try:
            return self.parent_id and self.cluster_state.tasks.data[
                self.parent_id]
        except KeyError:
            return None
...
class State:
    ...
    def __init__(self,
        ...
        self.tasks_by_worker = CallableDefaultdict(
            ...
            WeakSet)  # type: Mapping[str, WeakSet[Task]]
    ...
    def _create_dispatcher(self):
        ...
        def _event(event,
            ...
            if group == 'worker':
                ...
                (uuid, hostname, timestamp, local_received,
                 clock) = tfields(event)
