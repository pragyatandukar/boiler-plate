...
class Option:
    ...
    def __repr__(self):
        return '<Option: type->{} default->{!r}>'.format(
...
NAMESPACES = Namespace(
    ...
    beat=Namespace(__old__=OLD_NS_BEAT,
    ...
    arangodb=Namespace(__old__=old_ns('celery_arangodb'),
                       backend_settings=Option(None, type='dict')),
    mongodb=Namespace(
    ...
    worker=Namespace(
        ...
        cancel_long_running_tasks_on_connection_loss=Option(False,
                                                            type='bool'),
...
def _to_compat(ns, key, opt):
    if opt.old:
        return [(oldkey.format(key).upper(), ns + key, opt)
