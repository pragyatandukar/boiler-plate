...
class Inspect:
    ...
    def _prepare(self, reply):
        if reply:
            ...
            if (self.destination and not isinstance(self.destination,
                                                    (list, tuple))):
...
class Control:
    ...
    def revoke_by_stamped_headers(self,
                                  headers,
                                  destination=None,
                                  terminate=False,
                                  signal=TERM_SIGNAME,
        ...
        See Also:
            :meth:`broadcast` for supported keyword arguments.
        """
        result = self.broadcast('revoke_by_stamped_headers',
                                destination=destination,
                                arguments={
                                    'headers': headers,
                                    'terminate': terminate,
        ...
        if task_ids:
            return self.revoke(list(task_ids),
                               destination=destination,
                               terminate=terminate,
                               signal=signal,
                               **kwargs)
    ...
    def rate_limit(self, task_name, rate_limit, destination=None, **kwargs):
        ...
        See Also:
            :meth:`broadcast` for supported keyword arguments.
        """
        return self.broadcast('rate_limit',
                              destination=destination,
                              arguments={
                                  'task_name': task_name,
    ...
    def enable_events(self, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`.
        """
        return self.broadcast('enable_events',
                              arguments={},
                              destination=destination,
                              **kwargs)
    ...
    def disable_events(self, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`.
        """
        return self.broadcast('disable_events',
                              arguments={},
                              destination=destination,
                              **kwargs)
    ...
    def pool_grow(self, n=1, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`.
        """
        return self.broadcast('pool_grow',
                              arguments={'n': n},
                              destination=destination,
                              **kwargs)
    ...
    def pool_shrink(self, n=1, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`.
        """
        return self.broadcast('pool_shrink',
                              arguments={'n': n},
                              destination=destination,
                              **kwargs)
    ...
    def autoscale(self, max, min, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`.
        """
        return self.broadcast('autoscale',
                              arguments={
                                  'max': max,
                                  'min': min
                              },
    ...
    def shutdown(self, destination=None, **kwargs):
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`
        """
        return self.broadcast('shutdown',
                              arguments={},
                              destination=destination,
                              **kwargs)

    def pool_restart(self,
                     modules=None,
                     reload=False,
                     reloader=None,
                     destination=None,
        ...
        See Also:
            Supports the same arguments as :meth:`broadcast`
        """
        return self.broadcast('pool_restart',
                              arguments={
                                  'modules': modules,
                                  'reload': reload,
                                  'reloader': reloader,
